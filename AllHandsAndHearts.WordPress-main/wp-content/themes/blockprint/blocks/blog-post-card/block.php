...
$class_name = build_block_class_name( 'group/card @container relative', $block );
...
<article id="<?php echo esc_attr($anchor) ?>" class="<?php echo trim( esc_attr( $class_name ) ) ?>">
    <div class="flex flex-col gap-y-6">
        <figure class="w-full bg-neutral-100 aspect-(--aspect-ratio) overflow-hidden" style="--aspect-ratio:<?php echo $image_aspect_ratio ?>">
        ...
        <div class="flex flex-col gap-y-3">
            <div class="flex flex-col @2xs:flex-row-reverse items-start justify-end gap-3">
